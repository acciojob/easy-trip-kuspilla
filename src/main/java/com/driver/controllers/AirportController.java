...
public class AirportController {
    ...
    AirportService service_ob = new AirportService();
    ...
    public String getLargestAirportName(){
        ...
        //Incase of a tie return the Lexicographically smallest airportName
         String ans = service_ob.getLargestAirportName();
         return ans;
    ...
    public double getShortestDurationOfPossibleBetweenTwoCities(@RequestParam("fromCity") City fromCity, @RequestParam("toCity")City toCity){
        ...
        //If there is no direct flight between 2 cities return -1.
              double ans = service_ob.getShortestDurationOfPossibleBetweenTwoCities(fromCity, toCity);
    ...
    public int getNumberOfPeopleOn(@PathVariable("date") Date date,@RequestParam("airportName")String airportName){
        ...
        int ans = service_ob.getNumberOfPeopleOn(date, airportName);
        return ans;
    }
    ...
    public int calculateFlightFare(@RequestParam("flightId")Integer flightId){
        ...
        //This will not include the current person who is trying to book, he might also be just checking price
          int ans = service_ob.calculateFlightFare(flightId);
       return ans;
